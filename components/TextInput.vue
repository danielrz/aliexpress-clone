<template>
  <div>
    <client-only>
      <!-- virtual dom sync error without embedding with <client-only>
      see https://nuxt.com/docs/api/components/client-only
    In nuxt, The <ClientOnly> component renders its slot only in client-side. To import a component only on the client, register the component in a client-side only plugin.-->
      <input
